            ...
            {systems.map((system, i) => (
              <FadeIn key={system.id} delay={i * 0.1}>
                <Link 
                  ...
                  className="group block bg-white border border-gray-200 rounded-3xl p-8 md:p-12 hover:border-brand-300 hover:shadow-md transition-all duration-500 relative overflow-hidden h-full shadow-sm"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="w-16 h-16 bg-gray-50 border border-gray-200 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:border-brand-300 transition-all duration-500">
