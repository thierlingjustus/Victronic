        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-12">
              ...
              <FadeIn delay={0.3}>
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                  <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
                    <Zap className="w-6 h-6 text-[#00dfd8]" />
                  ...
                  <div className="space-y-6">
                    {product.specs.map((spec, i) => (
                      <div key={i} className="border-b border-white/10 pb-4 last:border-0 last:pb-0">
                        ...
                        <div className="text-lg font-medium text-gray-200">{spec.value}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* Synergy & Norms */}
              <FadeIn delay={0.4}>
                <div className="bg-gradient-to-br from-[#00dfd8]/10 to-transparent border border-[#00dfd8]/20 rounded-2xl p-8">
                  <h2 className="text-2xl font-bold mb-4 text-[#00dfd8]">Synergie & Normen</h2>
                  <p className="text-gray-300 leading-relaxed mb-6">
                    {product.synergy}
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-sm text-gray-400">
                      <CheckCircle2 className="w-5 h-5 text-[#00dfd8] shrink-0" />
              ...
              <FadeIn delay={0.5}>
                <div className="bg-white text-black rounded-2xl p-8 text-center">
                  ...
                  <Link to="/#contact" className="inline-flex items-center justify-center gap-2 bg-black text-white px-8 py-4 rounded-md font-medium hover:bg-gray-800 transition-colors w-full group">
